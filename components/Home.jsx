        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }} className={'ml-8 mb-16 w-[100%] z-10 max-w-[300px] sm:max-w-[100%] sm:ml-10  lg:pr-10 lg:ml-5'}>
          ...
          <motion.div className={'pt-8'} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.5 }}>
            <div className='flex flex-col sm:flex-row text-center w-fit gap-4 sm:gap-0'>
              ...
              <a href='#projects' className={" text-sm border-[1px] font-regular border-[#79d2e2] bg-[#79d2e2] py-[9px] px-9 mr-3 rounded-[5px]  text-white transition-all duration-200 hover:opacity-80 sm:text-base lg:text-lg"}>Proyectos</a>
              <a href='#contact' className={` text-sm border-[1px] font-regular border-[#79d2e2] py-[9px] px-6 rounded-[5px]  ${theme !== 'dark' ? 'text-gray-800' : 'text-[#fff]'} transition-all duration-200 hover:bg-[#79d2e2] hover:text-white  sm:text-base lg:text-lg`}>Quieres contactar?!</a>
            </div>
          </motion.div>
        </motion.div>
      </div>
