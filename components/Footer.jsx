  ...
  return (
    <footer className={`w-full flex flex-col ${theme === 'dark' ? 'bg-[#262737]' : 'bg-gray-200'}   justify-start pt-8 items-center min-h-[12vh]  relative `}>
      <div className={`max-w-[550px] ${theme === 'dark' ? 'text-gray-50' : ' text-[#262737]'} font-medium`}>
        Desarrollado con <a href="https://nextjs.org/" target='_blank' className='hover:text-sky-500 transition-colors'>Next.js</a> y <a href="https://tailwindcss.com/" target='_blank' className='hover:text-sky-500 transition-colors'>Tailwind CSS</a>
      </div>
